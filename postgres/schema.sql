...
INSERT INTO juzgados (id_sede, denominacion) VALUES
  ('0401', '1° JUZGADO PENAL UNIPERSONAL — JUP'),
  ('0401', '2° JUZGADO PENAL UNIPERSONAL — JUP'),
  ('0401', '3° JUZGADO PENAL UNIPERSONAL — JUP'),
  ('0401', '4° JUZGADO PENAL UNIPERSONAL — JUP'),
  ('0401', '1° JUZGADO PENAL COLEGIADO'),
  ('0401', '2° JUZGADO PENAL COLEGIADO'),
  ('0401', 'JUZGADO DE INVESTIGACIÓN PREPARATORIA — JIP'),
  ('0401', '1° JUZGADO UNIPERSONAL DE FLAGRANCIA'),
  ('0401', '2° JUZGADO UNIPERSONAL DE FLAGRANCIA'),
  ('0401', 'JUZGADO DE PAZ LETRADO');
